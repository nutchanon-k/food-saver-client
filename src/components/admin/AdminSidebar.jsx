...
const AdminSidebar = () => {
  ...
  return (
    <div
      className={`h-full bg-white border-r shadow-lg flex flex-col ${
      ...
      <div className="form-control mb-4">
        <div
          className={`flex items-center ${
            isExpanded ? "border rounded-lg p-2" : "px-5 py-2"
          }`}
        >
      ...
      <ul className="menu flex-grow space-y-2">
        <li>
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center w-full rounded-sm hover:bg-green-50 hover:text-green-600 focus:bg-green-50 focus:text-green-600 ${
      ...
      <ul className="menu space-y-2">
        ...
        <li>
          <button
            ...
            className="flex items-center w-full justify-center md:justify-start text-red-500"
          >
