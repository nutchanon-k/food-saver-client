    ...
    return (
        <div className={`h-full bg-white border-r shadow-lg flex flex-col ${isExpanded ? 'w-64' : 'w-24'} px-2 py-4 transition-all duration-300`}>
            ...
            <ul className="menu flex-grow space-y-2">
                ...
                <li>
                    <NavLink to="/manage-product" end className={({ isActive }) => `flex items-center w-full rounded-sm hover:bg-green-50 hover:text-green-600 focus:bg-green-50 focus:text-green-600 ${isExpanded ? 'justify-start' : 'justify-center'} ${isActive ? 'text-green-600 bg-green-50 border-l-4 border-green-600' : ''}`}>
                        <Utensils className="mr-2" />
                        {isExpanded && <span>Manage Product</span>}
                    </NavLink>
                </li>
                <li>
                    <NavLink to="/manage-order" end className={({ isActive }) => `flex items-center w-full rounded-sm hover:bg-green-50 hover:text-green-600 focus:bg-green-50 focus:text-green-600 ${isExpanded ? 'justify-start' : 'justify-center'} ${isActive ? 'text-green-600 bg-green-50 border-l-4 border-green-600' : ''}`}>
