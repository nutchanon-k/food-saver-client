...
const AdminEditProfile = () => {
    ...
    return (
        <div className="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow-lg w-full">
            ...
            <div className="flex justify-center mb-6">
                <div className="w-full max-w-xs">
                    <div
                        className="flex flex-col items-center justify-center w-full h-48 md:h-64 border-2 border-dashed rounded-lg cursor-pointer hover:bg-gray-100 p-2 relative"
                        onClick={() => document.getElementById('input-file').click()}
                    >
                        <input
                            type="file"
                            ...
                            onChange={(e) => setImage(e.target.files[0])}
                        />
                        {image || formUpdate.profilePicture ? (
                            <img
                        ...
                        {(image || formUpdate.profilePicture) && (
                            <CloseIcon
                                className="w-8 h-8 text-gray-400 absolute top-2 right-2 hover:text-red-500 cursor-pointer"
                                onClick={(e) => {
                                    e.stopPropagation();
                                    document.getElementById('input-file').value = '';
                                    setImage(null);
                                    setFormUpdate((prev) => ({ ...prev, profilePicture: "" }));
                                }}
                            />
                        )}
                    </div>
            ...
            <form className="space-y-6">
                ...
                <div className="flex flex-col p-4 items-center gap-4 md:flex-row">
                    {loading ? (
                        <div className="flex justify-center w-full">
                            <span className="loading loading-dots loading-lg"></span>
                        </div>
                        ...
                        <>
                            <button
                                ...
                                className="w-full md:w-1/2 bg-red-500 text-white py-3 px-4 rounded-xl hover:bg-red-600 transition-colors"
                            >
                                Back
                            </button>
                            <button
                                type="submit"
                                onClick={(e) => hdlSubmit(e)}
                                className="w-full md:w-1/2 bg-green-500 text-white py-3 px-4 rounded-xl hover:bg-green-600 transition-colors"
                            >
                                Save
                            </button>
                        </>
